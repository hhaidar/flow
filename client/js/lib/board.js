    ...
    render: function() {
        return (
            ...
            >
                ...
                <Progress
                    items={this.getTaskData('jira-sde', 'items')}
                    title="Jira" subtitle={this.getTaskData('jira-sde', 'sprint')}
                    width="4" height="2" x="0" y="1" />
                <Status
                    value={this.getTaskData('jenkins-sde', 'value')}
                    total={this.getTaskData('jenkins-sde', 'total')}
                    title="Jenkins" width="2" height="2" x="4" y="2" />
            </div>
        );
    }
});
